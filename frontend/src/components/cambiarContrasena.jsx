...
const cambiarContrasena = () => {
    return (
        <form class="max-w-sm mx-auto">       
            <div class="mb-5">
                <label htmlFor="contrasenaActual" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contraseña Actual</label>
            ...
            <div class="mb-5">
                <label htmlFor="nuevaContrasena" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nueva Contraseña</label>
                <input type="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            </div>
            <div class="mb-5">
                <label htmlFor="repetirContrasena" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Repetir nueva contraseña</label>
                <input type="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            </div>
